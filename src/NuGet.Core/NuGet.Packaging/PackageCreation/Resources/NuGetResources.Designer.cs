...
namespace NuGet.Packaging.PackageCreation.Resources {
    ...
    internal class NuGetResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The element &apos;license&apos; requires exactly one of the &apos;expression&apos; and &apos;src&apos; attributes..
        /// </summary>
        internal static string Manifest_LicenseElementMissingAttributes {
            get {
                return ResourceManager.GetString("Manifest_LicenseElementMissingAttributes", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enabling license acceptance requires a license or licenseUrl to be specified.  The licenseUrl will be deprecated, consider using the license metadata..
        /// </summary>
